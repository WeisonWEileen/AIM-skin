...
if __name__ == '__main__':
    ...
    save_path = './result_net/C3d_s'+ str(number_of_segments) + '.pth'
    best_acc = 0.0
    Accuracy = []
    ...
    for epoch in range(num_epochs):
        ...
        for step, data in enumerate(train_data, start=0):
            ...
            sensor = data[0]
            sensor = sensor.view(sensor.size(0),1,math.floor(5000 / number_of_segments),8,8)   # [10*batch_size,1,50,8,8]
